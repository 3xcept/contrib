...
func (suite *AdapterTestSuite) TestValidMessage() {
	...
	suite.Equal("github.com/3xcept/contrib/entproto/internal/entprototest/ent/proto/entpb",
...
func (suite *AdapterTestSuite) TestMessageWithPackageName() {
	...
	suite.Equal("github.com/3xcept/contrib/entproto/internal/entprototest/ent/proto/io/entgo/apps/todo",
		fd.GetFileOptions().GetGoPackage())
}
